...
public class TestHMMC {

	public static final String TRAININDATA = "/home/azanzi/These/"
			+ "1-Journal_Web_Semantic/dataSources/2-C/1-TrainDS";
...
//			+ "knowExtracFromSC/experiments/DataSources/1-TrainDS/1-raw_data";
	...
	public static final String EXPERIMENTINGDATA = "/home/azanzi/These/"
			+ "1-Journal_Web_Semantic/dataSources/2-C/2-mapServer";
	
	public static final String HMMPARAMETERS = "/home/azanzi/These/"
			+ "1-Journal_Web_Semantic/dataSources/2-C/parameters";
	
	public static final String KNOWLEDGEEXTRACTED = "/home/azanzi/These/"
			+ "1-Journal_Web_Semantic/dataSources/2-C/mapserver";
...
//		System.out.println("***********The Viterbi table from the first file**********************");
		...
		for (String file : dataSource) {
			...
			knowledgeExtracted = sourceCodeFiles.get(i).substring(67);
